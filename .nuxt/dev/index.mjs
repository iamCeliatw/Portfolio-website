...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash } from 'file:///Users/shuting/Desktop/Portfolio-website/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/shuting/Desktop/Portfolio-website/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/shuting/Desktop/Portfolio-website/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/shuting/Desktop/Portfolio-website/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/shuting/Desktop/Portfolio-website/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/shuting/Desktop/Portfolio-website/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/shuting/Desktop/Portfolio-website/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/shuting/Desktop/Portfolio-website/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/shuting/Desktop/Portfolio-website/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/shuting/Desktop/Portfolio-website/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/shuting/Desktop/Portfolio-website/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/shuting/Desktop/Portfolio-website/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/shuting/Desktop/Portfolio-website/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/shuting/Desktop/Portfolio-website/node_modules/consola/dist/index.mjs';
import devalue from 'file:///Users/shuting/Desktop/Portfolio-website/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getContext } from 'file:///Users/shuting/Desktop/Portfolio-website/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file:///Users/shuting/Desktop/Portfolio-website/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/shuting/Desktop/Portfolio-website/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/shuting/Desktop/Portfolio-website/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/shuting/Desktop/Portfolio-website/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/shuting/Desktop/Portfolio-website","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/shuting/Desktop/Portfolio-website/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/shuting/Desktop/Portfolio-website/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/shuting/Desktop/Portfolio-website/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/shuting/Desktop/Portfolio-website/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _7jfze25Pkm = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/shuting/Desktop/Portfolio-website";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _33meppZm6i = (nitroApp) => {
...
const getClientManifest = () => import('file:///Users/shuting/Desktop/Portfolio-website/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/shuting/Desktop/Portfolio-website/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
